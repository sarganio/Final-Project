...
using std::string;
	...
	public:
		...
		TcpClient(string myIP, unsigned short myPort, unsigned short toPort, string hostname, Message* mess,bool& isConnected);
		...
		*/
		int connect(unsigned short port, std::string hostname, Message* mess,bool& isConnected);
	};
